...
namespace InputManager
{
    ...
    public class Keyboard
    {
        ...
        private extern static int SendInput(int cInputs, ref INPUT pInputs, int cbSize);
        ...
        [DllImport("user32.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall, SetLastError = true)]
        private extern static IntPtr GetKeyboardLayout(uint idThread);
        ...
        {
            uint ScanCode = MapVirtualKey(System.Convert.ToUInt32(VKey), MapVirtualKeyMapTypes.MAPVK_VK_TO_VSC);
        ...
        private struct ScanKey
        {
            ...
            public ScanKey(uint sCode, Boolean ex)
            {
                // = false
                ScanCode = sCode;
                Extended = ex;
        ...
        ///             ''' <remarks></remarks>
        public static void ShortcutKeys(Keys[] kCode, int Delay)
        {
            // = 0
        ...
        public static void KeyDown(Keys kCode)
        {
            ...
            input.mkhi.ki.dwFlags = KEYEVENTF_SCANCODE | (sKey.Extended ? KEYEVENTF_EXTENDEDKEY : System.Convert.ToUInt32(0));
        ...
        private struct KeyPressStruct
        {
            public Keys[] Keys;
            public int Delay;
            public KeyPressStruct(Keys[] KeysToPress, int DelayTime)
            {
                // = 0
                Keys = KeysToPress;
                Delay = DelayTime;
    ...
    public class VirtualKeyboard
    {
        ...
        public extern static bool keybd_event(UInt32 bVk, UInt32 bScan, UInt32 dwFlags, UInt32 dwExtraInfo);
        ...
        public static void KeyDown(Keys kCode)
        {
            keybd_event(System.Convert.ToUInt32(kCode), 0, 0, 0);
        }
        ...
        public static void KeyUp(Keys kCode)
        {
            keybd_event(System.Convert.ToUInt32(kCode), 0, KEYEVENTF_KEYUP, 0);
        }
    ...
    public class Mouse
    {
        ...
        public static void SendButton(MouseButtons mButton)
        {
            ...
            input.mkhi.mi.dwFlags = System.Convert.ToUInt32(mButton);
            input.mkhi.mi.dx = 0;
            input.mkhi.mi.dy = 0;
            int cbSize = Marshal.SizeOf(typeof(INPUT));
            SendInput(1, ref input, cbSize);
        ...
        ///             ''' <remarks></remarks>
        public static void PressButton(MouseKeys mKey, int Delay)
        {
            // = 0
            ButtonDown(mKey);
            if (Delay > 0)
        ...
        public static void Scroll(ScrollDirection Direction)
        {
            ...
            input.mkhi.mi = new MOUSEINPUT();
            input.mkhi.mi.dwExtraInfo = IntPtr.Zero;
            input.mkhi.mi.dwFlags = System.Convert.ToUInt32(MouseButtons.Wheel);
            input.mkhi.mi.mouseData = System.Convert.ToInt32(Direction);
            input.mkhi.mi.dx = 0;
            input.mkhi.mi.dy = 0;
            int cbSize = Marshal.SizeOf(typeof(INPUT));
            SendInput(1, ref input, cbSize);
